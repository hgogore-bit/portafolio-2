document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        es: {
            ...
            "reel-desc": "Un reel creativo personal que combina dirección de arte, diseño de movimiento, narrativa, producción y experimentación con IA. La música de esta pieza fue diseñada desde cero para sincronizar las emociones transmitidas tanto por la vista como por el oído; una banda sonora 100% original.",
            ...
            "book-isacup-bullet-3": "Cobertura fotográfica completa de partidos nacionales y viajes a torneos europeos.",
        ...
        en: {
            ...
            "reel-heading": "HGO Creative Reel — Art Direction, Motion & AI",
            "reel-desc": "A personal creative reel combining art direction, motion design, storytelling, production and AI experimentation. The music for this piece was designed from scratch to harmonize the emotions transmitted through both eye and ear; a 100% original soundtrack.",
            ...
            "book-isacup-bullet-3": "Comprehensive photographic coverage of national matches and travels to European tournaments.",
